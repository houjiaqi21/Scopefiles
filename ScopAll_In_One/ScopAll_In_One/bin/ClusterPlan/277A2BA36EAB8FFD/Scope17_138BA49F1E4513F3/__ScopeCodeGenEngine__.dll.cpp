...
#pragma region SV1_Extract_Split
    ...
    public:
        ...
        void Init()
        {
            constexpr int64_t expectedNumberOfRowsPerPartition_0 = 1ll;
...
#pragma region SV4_Extract_Split
    ...
    public:
        ...
        void Init()
        {
            constexpr int64_t expectedNumberOfRowsPerPartition_0 = 34ll;
            sstreamOutputStream_0.Init(expectedNumberOfRowsPerPartition_0);
        }
...
#pragma region SV13_Combine_Split
    ...
    public:
        ...
        void Init()
        {
            constexpr int64_t expectedNumberOfRowsPerPartition_0 = 180ll;
            sstreamOutputStream_0.Init(expectedNumberOfRowsPerPartition_0);
        }
