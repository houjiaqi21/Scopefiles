...
#region ==BEGIN USER CODE==
	...
	public class Row_IId_Integer_Start_DateTime : Row
	{
		...
		public Row_IId_Integer_Start_DateTime(Schema schema, ColumnData[] columns) : base(schema, columns) { }
		public Row_IId_Integer_Start_DateTime(Schema schema) : base(schema)
		{
		...
		public Row_IId_Integer_Start_DateTime() : base(BuildSchema(), BuildColumnData())
		{
			for (int i = 0; i < _columns.Length; ++i)
			{
				this[i] = _columns[i];
	...
	public class Row_b_Integer_IId_Integer_Start_DateTime : Row
	{
		private static readonly System.Tuple<string,ScopeRuntime.ColumnDataType,Type,ColumnDataCtor,string>[] _columnTable = 
		{
		...
		public Row_b_Integer_IId_Integer_Start_DateTime(Schema schema, ColumnData[] columns) : base(schema, columns) { }
		public Row_b_Integer_IId_Integer_Start_DateTime(Schema schema) : base(schema)
		{
			for (int i = 0; i < _columns.Length; ++i)
			{
				this[i] = _columns[i];
		...
		public Row_b_Integer_IId_Integer_Start_DateTime() : base(BuildSchema(), BuildColumnData())
		{
			for (int i = 0; i < _columns.Length; ++i)
			{
				this[i] = _columns[i];
	...
	public class Row_IId_Integer_Start_DateTime_b_Integer : Row
	{
		private static readonly System.Tuple<string,ScopeRuntime.ColumnDataType,Type,ColumnDataCtor,string>[] _columnTable = 
		{
			new System.Tuple<string,ScopeRuntime.ColumnDataType,Type,ColumnDataCtor,string>("IId", ScopeRuntime.ColumnDataType.Integer, typeof(System.Int32), null, null),
		...
		public Row_IId_Integer_Start_DateTime_b_Integer(Schema schema, ColumnData[] columns) : base(schema, columns) { }
		public Row_IId_Integer_Start_DateTime_b_Integer(Schema schema) : base(schema)
		{
			for (int i = 0; i < _columns.Length; ++i)
			{
				this[i] = _columns[i];
		...
		public Row_IId_Integer_Start_DateTime_b_Integer() : base(BuildSchema(), BuildColumnData())
		{
			for (int i = 0; i < _columns.Length; ++i)
			{
				this[i] = _columns[i];
