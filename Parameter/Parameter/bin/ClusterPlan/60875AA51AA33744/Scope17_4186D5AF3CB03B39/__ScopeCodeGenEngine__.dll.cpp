...
// Explicit instantiations for templated functions that are defined in managed code
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& os, const Extract_0_Data0& row)
        {
            ...
            ScopeEngine::OutputRowContent(
                std::string{ u8"IId:int,Start:DateTime" },
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& os, const Process_1_Data0& row)
        {
            ...
            ScopeEngine::OutputRowContent(
                std::string{ u8"IId:int,Start:DateTime,b:int" },
                reinterpret_cast<const char*>(&row),
                os);
    ...
    static_assert(sizeof(Process_1_Data0) == 24, "Incorrect size of row schema");
...
namespace ScopeGeneratedClasses
{
    ...
    ExtractorType1_SV1_Extr ** extractor_0 = (ExtractorType1_SV1_Extr **)extractor_0_array.get();
        ...
        typedef FilterTransformer<ExtractorType1_SV1_Extr, Extract_0_Data0, Process_1_Data0, UID_Process_1> FilterTransformerType_Process_1;
        ...
        unique_ptr<UnionAllType_Process_1_SV1_Extract_out0_connector> unionall_Process_1_SV1_Extract_out0_connector_ptr(new UnionAllType_Process_1_SV1_Extract_out0_connector(filterTransformer_Process_1,filterTransformer_Process_1_count,12,419430400,UID_ParallelUnionAll_Process_1));
        ...
        typedef Outputter<UnionAllType_Process_1_SV1_Extract_out0_connector, Process_1_Data0, TextOutputPolicy<Process_1_Data0, UID_SV1_Extract_out0>, TextOutputStream<TextOutputStreamTraitsConst<'\t', '\0', false, true, false, false, false, Default, false, CharFormat_uint16>, CosmosOutput>, false> OutputterType2_SV1_Extr;
        // Construct operator and initialize it
        unique_ptr<OutputterType2_SV1_Extr> outputter_SV1_Extract_out0_ptr(new OutputterType2_SV1_Extr(unionall_Process_1_SV1_Extract_out0_connector, outputs[0].outputFileName, false, x_outputBufSize, x_outputBufCnt, OutputStreamParameters('\t', "\r\n", '\0', static_cast<const char*>(__nullptr), false, true, false, false, NULL, Default, false, CharFormat_uint16), UID_SV1_Extract_out0));
